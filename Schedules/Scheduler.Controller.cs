...
namespace SupplierIdentification.Schedulers.Controller
{
    [Route("apps/SupplierIdentification/latest/api/Scheduler/[action]")]
    [Route("apps/SupplierIdentification/{v:int:min(1)}/api/Scheduler/[action]")]
