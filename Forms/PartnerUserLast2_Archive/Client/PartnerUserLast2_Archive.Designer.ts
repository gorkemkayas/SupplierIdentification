...
import "./PartnerUserLast2_Archive.css";

export class Designer extends Controls.Form {
    // properties
    Row1: Controls.Section;
Column1: Controls.Column;
PartnerUserLast2_Archive_Grid: Controls.DataGrid;
FILTERPARAMS: Controls.TextBox;
ctxPartnerMenu: Controls.ContextMenu;
