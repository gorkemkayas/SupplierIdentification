...
namespace SupplierIdentification.Forms {
    ...
    public partial class Form1 : Form<E_SupplierIdentification_Form1Entity> {
...
Name = "Form1";
FormId = "b07f26ee-9c32-45ca-ae5c-29fa15cb2c8d";
...
ControlId = "6d32474a-3b65-47c0-ad81-5e62d9a2e5f2",
Name = "Section1",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
...
Column1 = new Column {
ControlId = "ac92ddda-fd63-4f45-abd4-e388d9380cd5",
Name = "Column1",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
